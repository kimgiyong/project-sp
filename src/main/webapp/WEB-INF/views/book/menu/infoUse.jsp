		...
		<div id="content">
			...
			<div id="borrowInfo" class="contentDiv">
				...
				<div class="details">
					...
					가장 높은 등급 부터'영원한 책의 친구', '책의 친한 친구', '책의 친구', '책과는 아직 낯선 사람', '손님' 으로 5가지의 등급제로 운영이 됩니다.<br><br>
					<span class="ranking one">'영원한 책의 친구'</span><br> 최대 10권의 책을 빌릴 수 있으며 한 번 빌릴수 있는 기간이 1달로 연장 됩니다.<br><br>
					<span class="ranking two">'책의 친한 친구'</span> <br> 최대 5권의 책을 빌릴 수 있으며 한 번 빌릴수 있는 기간이 20일로 연장 됩니다.<br><br>
					<span class="ranking three">'책의 친구'</span><br> 최대 3권의 책을 빌릴 수 있으며 한 번 빌릴 수 있는 기간이 2주로 연장 됩니다.<br><br>
					<span class="ranking fore">'책과는 아직 낯선 사람'</span><br>최대 2권의 책을 빌릴 수 있으며 한 번 빌릴 수 있는 기간이 1주일 입니다.<br>
					&emsp;<span class="texta">* 기본 등급으로 좋은향 홈페이지에 회원가입을하시면 올라가는 등급입니다.</span><br><br>
					<span class="ranking five">'손님'</span><br><span class="texta">'손님'등급으로는 책을 빌릴 수 없으며 회원가입을 해야 합니다.</span><br><br>
					
					등급은 일정 포인트 이상이 되면 자동으로 승급이 가능합니다.<br>
					또한, 기부를 하신다면 소정의 포인트를 쌓아 최대 '책의 친구'등급 까지 올라 가실 수 있습니다.<br>
					<br>
					<span class="textb">※ 포인트를 쌓는 방법</span><br>
						&emsp;1.반납기간을 잘 지켜 포인트를 쌓는다.<br>
						&emsp;2.책을 자주 빌려 읽으며 포인트를 쌓는다.<br>
						&emsp;3.기부금을 내어 포인트를 얻는다.<br>
				</div>
			</div>
